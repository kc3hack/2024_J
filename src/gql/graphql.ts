...
export type Mutation_Root = {
  ...
  update_GuidingNodes_many?: Maybe<
    Array<Maybe<GuidingNodes_Mutation_Response>>
  >;
  ...
  update_point_relation_many?: Maybe<
    Array<Maybe<Point_Relation_Mutation_Response>>
  >;
};
...
export type GetCorrespondQuery = {
  __typename?: "query_root";
  point_relation: Array<{
    __typename?: "point_relation";
    rFrom: { __typename?: "GuidingNodes"; id: any };
    rTo: { __typename?: "GuidingNodes"; id: any };
  }>;
};
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "getMapPair" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "GuidingNodes" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<GetMapPairQuery, GetMapPairQueryVariables>;
export const GetCorrespondDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getCorrespond" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "point_relation" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
...
} as unknown as DocumentNode<GetCorrespondQuery, GetCorrespondQueryVariables>;
